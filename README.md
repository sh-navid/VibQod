...
You can also manually configure these settings by pressing `Ctrl+Shift+P`, typing "N8X" and selecting **“NaBotX: Open Settings.”**
...
* **Predefined Commands:**  
  * `/structure` – Sends your project structure to the chat.  
